  ...
  static List<Restaurant> getRestaurants() {
    return [
      ...
      Restaurant(
        ...
        deliveryTime: 30,
        deliveryFee: 2.99,
        imageUrl: 'https://images.unsplash.com/photo-1569562211093-4ed0d0758f12?w=400&h=300&fit=crop',
      ),
  ...
  static List<FoodItem> getMoreFoodItems() {
    return [
      ...
      FoodItem(
        ...
        description: 'Marinated beef bulgogi over steamed rice with vegetables and kimchi',
        price: 15.99,
        imageUrl: 'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=400&h=300&fit=crop',
        category: 'Korean',
        rating: 4.8,
      ...
      FoodItem(
        ...
        description: 'Vietnamese baguette with pork, pâté, pickled vegetables, and cilantro',
        price: 8.99,
        imageUrl: 'https://images.unsplash.com/photo-1539252554453-80ab65ce3586?w=400&h=300&fit=crop',
        category: 'Vietnamese',
        rating: 4.6,
      ...
      FoodItem(
        id: '34',
        name: 'Hot Buffalo Wings (12 pieces)',
      ...
      FoodItem(
        id: '35',
        name: 'Honey BBQ Wings (12 pieces)',
        description: 'Sweet and smoky BBQ wings with honey glaze',
        price: 14.99,
        imageUrl: 'https://images.unsplash.com/photo-1562967916-eb82221dfb92?w=400&h=300&fit=crop',
        category: 'Wings',
        rating: 4.6,
      ...
      FoodItem(
        id: '36',
        name: 'Fried Chicken Bucket (8 pieces)',
        description: 'Crispy fried chicken pieces with secret herbs and spices',
        price: 19.99,
      ...
      FoodItem(
        ...
        description: 'Grilled chicken, romaine lettuce, and caesar dressing in tortilla',
        price: 10.99,
        imageUrl: 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=400&h=300&fit=crop',
        category: 'Wraps',
        rating: 4.4,
      ...
      FoodItem(
        id: '42',
        name: 'Tonkotsu Ramen',
        description: 'Rich pork bone broth with chashu pork, egg, and green onions',
        price: 14.99,
        imageUrl: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&h=300&fit=crop',
        category: 'Ramen',
        rating: 4.9,
      ...
      FoodItem(
        ...
        description: 'Fresh lobster tail with garlic butter and lemon',
        price: 29.99,
        imageUrl: 'https://images.unsplash.com/photo-1544943910-4c1dc44aab44?w=400&h=300&fit=crop',
        category: 'Seafood',
        rating: 4.9,
      ...
      FoodItem(
        ...
        description: 'Beer-battered cod with thick-cut fries and mushy peas',
        price: 16.99,
