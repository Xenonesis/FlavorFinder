  ...
  static List<Restaurant> getRestaurants() {
    return [
      ...
      Restaurant(
        ...
        deliveryTime: 25,
        deliveryFee: 2.49,
        imageUrl: 'https://images.unsplash.com/photo-1565299585323-38174c4a6471',
      ),
      Restaurant(
        id: '11',
        name: 'Taco Fiesta',
      ...
      Restaurant(
        ...
        deliveryTime: 30,
        deliveryFee: 3.99,
        imageUrl: 'https://images.unsplash.com/photo-1544510808-efac33be2456',
      ),
      Restaurant(
        id: '13',
        name: 'Kebab Corner',
  ...
  static List<FoodItem> getFoodItems() {
    return [
      ...
      FoodItem(
        ...
        price: 13.99,
        imageUrl: 'https://images.unsplash.com/photo-1606755962773-d324e2d53014',
        category: 'Sandwiches',
        rating: 4.6,
        isVegetarian: false,
